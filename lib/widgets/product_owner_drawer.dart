...
class ProductOwnerDrawer extends StatelessWidget {
  final String selectedItem;
  final Function(String)? onItemSelected; // Make this optional

  const ProductOwnerDrawer ({Key? key, required this.selectedItem, this.onItemSelected})
      : super(key: key);
    ...
    return Drawer(
      ...
      child: ListView(
        ...
        children: [
          ...
          _buildDrawerItem(context, 'My Tasks', Icons.task,
              isSelected: selectedItem == 'My Tasks'),
          _buildDrawerItem(context, 'My Projects', Icons.assignment,
              isSelected: selectedItem == 'My Projects'),
          _buildDrawerItem(context, 'Clients Feedback', Icons.feedback_rounded,
              isSelected: selectedItem == 'Clients Feedback'),
          _buildDrawerItem(context, 'Add Members', Icons.person_add,
              isSelected: selectedItem == 'Add Members'),
          _buildDrawerItem(context, 'Time Scheduling', Icons.access_time_filled,
              isSelected: selectedItem == 'Time Scheduling'),
         // _buildDrawerItem(context, 'Activity Logs', Icons.door_sliding_sharp,
           //   isSelected: selectedItem == 'Activity Logs'),
      ...
      onTap: () async {
        ...
        if (isLogout) {
          ...
          if (onItemSelected != null) {
            ...
            NavigationService().onProductOwnerDrawerItemSelected(context, title);
          }
        }
      },
    );
