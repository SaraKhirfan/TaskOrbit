// // File: lib/widgets/sm_drawer.dart
...
class SMDrawer extends StatelessWidget {
  final String selectedItem;
  final Function(String)? onItemSelected; // Make this optional

  const SMDrawer({Key? key, required this.selectedItem, this.onItemSelected})
      : super(key: key);
      ...
      child: ListView(
        ...
        children: [
          ...
          _buildDrawerItem(
            ...
            'Task Management',
            Icons.view_list,
            isSelected: selectedItem == 'Task Management',
          ),
          _buildDrawerItem(
            context,
            'Workload Monitoring',
            Icons.person_pin_rounded,
            isSelected: selectedItem == 'Workload Monitoring',
          ),
          _buildDrawerItem(
            context,
            'Retrospective',
      ...
      onTap: () async {
        ...
        if (isLogout) {
          ...
          if (onItemSelected != null) {
            ...
            NavigationService().onScrumMasterDrawerItemSelected(context, title);
          }
        }
      },
    );
