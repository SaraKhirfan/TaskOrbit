...
class ClientDrawer extends StatelessWidget {
  ...
  const ClientDrawer ({Key? key, required this.selectedItem, this.onItemSelected})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Drawer(
      ...
      _buildDrawerItem(context, 'My Profile', Icons.person,
          ...
          _buildDrawerItem(context, 'Time Scheduling', Icons.access_time_filled_rounded,
      ...
      _buildDrawerItem(context, 'Feedback', Icons.feedback,
          isSelected: selectedItem == 'Feedback'),
          Divider(),
      ...
      onTap: () async {
        ...
        if (isLogout) {
          ...
          if (onItemSelected != null) {
            ...
            NavigationService().onClientDrawerItemSelected(context, title);
          }
        }
      },
    );
