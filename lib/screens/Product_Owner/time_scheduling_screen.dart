...
class TimeSchedulingScreen extends StatefulWidget {
  const TimeSchedulingScreen({Key? key}) : super(key: key);

  @override
  State<TimeSchedulingScreen> createState() => _TimeSchedulingScreenState();
}

class _TimeSchedulingScreenState extends State<TimeSchedulingScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: const ProductOwnerDrawer(selectedItem: 'Time Scheduling'),
      body: Container(
        width: double.infinity,
