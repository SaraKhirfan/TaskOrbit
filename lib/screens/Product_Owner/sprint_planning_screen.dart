...
class SprintPlanningScreen extends StatefulWidget {
  final Map<String, dynamic> project;

  const SprintPlanningScreen({super.key, required this.project});

  @override
  State<SprintPlanningScreen> createState() => _SprintPlanningScreenState();
}

class _SprintPlanningScreenState extends State<SprintPlanningScreen> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  List<Map<String, dynamic>> sprints = [];
  Map<String, dynamic>? lastCompletedSprint;
