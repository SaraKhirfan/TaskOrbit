...
class POChatScreen extends StatefulWidget {
  const POChatScreen({Key? key}) : super(key: key);

  @override
  State<POChatScreen> createState() => _POChatScreenState();
}

class _POChatScreenState extends State<POChatScreen> {
