...
class PoSprintTaskDetailsScreen extends StatefulWidget {
  final Map<String, dynamic> task;
  final String storyStatus;
  final String projectId;
  const PoSprintTaskDetailsScreen({
    Key? key,
    required this.task,
  ...
  @override
  _PoSprintTaskDetailsScreenState createState() => _PoSprintTaskDetailsScreenState();
}
class _PoSprintTaskDetailsScreenState extends State<PoSprintTaskDetailsScreen> {
  ...
  Widget _buildReadOnlyStatusSection() {
    String currentStatus = widget.task['status'] ?? 'To Do';
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 6),
      child: Card(
        color: Color(0xFFFDFDFD),
