...
class ReportsAnalyticsScreen extends StatefulWidget {
  ...
  const ReportsAnalyticsScreen({Key? key, required this.project}) : super(key: key);
  ...
  void _toggleExpand(int index) {
    setState(() {
      ...
      for (int i = 0; i < _retrospectiveReports.length; i++) {
        _retrospectiveReports[i]['isExpanded'] = (i == index) && !_retrospectiveReports[index]['isExpanded'];
      }
    });
  }
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    "${(_projectCompletionRate * 100).toInt()}% Completed",
                                    style: const TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.bold,
                                      color: Color(0xFF313131),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            "${(_sprintCompletionRate * 100).toInt()}% Completed",
                            style: const TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                              color: Color(0xFF313131),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Icon(
                                    report['isExpanded'] ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down,
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            const SizedBox(height: 4),
                                            Text(
                                              DateFormat('MMM dd, yyyy').format(report['dateSubmitted']),
                                              style: const TextStyle(
                                                fontSize: 14,
                                                color: Color(0xFF313131),
                                              ),
                                      ...
                                      Row(
                                        ...
                                        children: List.generate(5, (i) {
                                          return Icon(
                                            Icons.star,
                                            size: 18,
                                            color: i < report['satisfactionScore'].floor()
                                                ? Colors.amber
                                                : i < report['satisfactionScore']
