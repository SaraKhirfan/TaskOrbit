...
class TMTimeSchedulingScreen extends StatefulWidget {
  const TMTimeSchedulingScreen({Key? key}) : super(key: key);

  @override
  State<TMTimeSchedulingScreen> createState() => _TMTimeSchedulingScreenState();
}

class _TMTimeSchedulingScreenState extends State<TMTimeSchedulingScreen> {
  final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  int _selectedIndex = 0; // Set index for bottom navigation
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: TeamMemberDrawer(selectedItem: 'Time Scheduling'),
      body: Container(
