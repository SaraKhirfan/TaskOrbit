...
class TeamMemberSettings extends StatefulWidget {
  const TeamMemberSettings({Key? key}) : super(key: key);

  @override
  State<TeamMemberSettings> createState() => _TeamMemberSettingsState();
}

class _TeamMemberSettingsState extends State<TeamMemberSettings> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: TeamMemberDrawer(selectedItem: 'Settings'),
      body: Container(
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            _buildNavItem(Icons.work_history_rounded, "Workload", 2),
