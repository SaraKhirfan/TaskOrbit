...
class TMTeamOverviewScreen extends StatefulWidget {
  final Map<String, dynamic> project;

  const TMTeamOverviewScreen({Key? key, required this.project}) : super(key: key);

  @override
  State<TMTeamOverviewScreen> createState() => _TMTeamOverviewScreenState();
}

class _TMTeamOverviewScreenState extends State<TMTeamOverviewScreen> {
