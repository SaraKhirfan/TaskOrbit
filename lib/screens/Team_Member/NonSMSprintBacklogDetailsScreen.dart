...
import '../ScrumMaster/sm_task_details_screen.dart';
import '../../widgets/sm_app_bar.dart';
import '../../services/sprint_service.dart';
import 'Nonsm_task_details_screen.dart';

class NonSMSprintBacklogDetailsScreen extends StatefulWidget {
  final Map<String, dynamic> story;
  final String projectId;

  const NonSMSprintBacklogDetailsScreen({
    Key? key,
    required this.story,
  ...
  @override
  _NonSMSprintBacklogDetailsScreenState createState() =>
      _NonSMSprintBacklogDetailsScreenState();
}

class _NonSMSprintBacklogDetailsScreenState
    extends State<NonSMSprintBacklogDetailsScreen> {
  ...
  void _navigateToTaskDetails(Map<String, dynamic> task) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => NonSMTaskDetailsScreen(
          task: task,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: SMAppBar(scaffoldKey: _scaffoldKey, title: "Profile"),
