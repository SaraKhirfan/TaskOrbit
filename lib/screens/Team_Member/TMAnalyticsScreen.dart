...
class TMAnalyticsScreen extends StatefulWidget {
  final Map<String, dynamic> project;

  const TMAnalyticsScreen({Key? key, required this.project}) : super(key: key);

  @override
  State<TMAnalyticsScreen> createState() => _TMAnalyticsScreenState();
}

class _TMAnalyticsScreenState extends State<TMAnalyticsScreen> {
