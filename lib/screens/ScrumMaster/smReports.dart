...
class SMReportsAnalyticsScreen extends StatefulWidget {
  ...
  const SMReportsAnalyticsScreen({Key? key, required this.project}) : super(key: key);

  @override
  State<SMReportsAnalyticsScreen> createState() => _SMReportsAnalyticsScreenState();
}

class _SMReportsAnalyticsScreenState extends State<SMReportsAnalyticsScreen> {
