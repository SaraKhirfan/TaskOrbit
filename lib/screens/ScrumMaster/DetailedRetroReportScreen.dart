...
class DetailedRetroReportScreen extends StatefulWidget {
  final Map<String, dynamic> retroReport;

  const DetailedRetroReportScreen({
    Key? key,
    required this.retroReport,
  }) : super(key: key);

  @override
  _DetailedRetroReportScreenState createState() => _DetailedRetroReportScreenState();
}

class _DetailedRetroReportScreenState extends State<DetailedRetroReportScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: SMAppBar(scaffoldKey: _scaffoldKey, title: "Retrospective Report"),
