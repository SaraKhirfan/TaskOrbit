// File: lib/screens/Scrum_Master/sm_my_todos.dart
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:provider/provider.dart';
import 'package:task_orbit/main.dart';
import 'package:task_orbit/screens/Product_Owner/AddToDo.dart';
import 'package:task_orbit/services/TodoService.dart'; // Updated import
import '../../widgets/sm_drawer.dart';
import '../../widgets/sm_app_bar.dart';
import '../../widgets/sm_bottom_nav.dart';

class SMMyTodos extends StatefulWidget { // Renamed class
  const SMMyTodos({super.key});

  @override
  State<SMMyTodos> createState() => _SMMyTodosState();
}

class _SMMyTodosState extends State<SMMyTodos> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      key: _scaffoldKey,
      appBar: SMAppBar(scaffoldKey: _scaffoldKey, title: "My Tasks"),
      drawer: SMDrawer(selectedItem: 'My Tasks'),
