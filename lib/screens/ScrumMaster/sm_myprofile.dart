...
class SMMyProfileScreen extends StatefulWidget {
  const SMMyProfileScreen({Key? key}) : super(key: key);

  @override
  State<SMMyProfileScreen> createState() => _SMMyProfileScreenState();
}

class _SMMyProfileScreenState extends State<SMMyProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: SMDrawer(selectedItem: 'My Profile'),
      body: _isLoading
