...
class SMSprintBacklogDetailsScreen extends StatefulWidget {
  final Map<String, dynamic> story;
  final String projectId;

  const SMSprintBacklogDetailsScreen({
    Key? key,
    required this.story,
  ...
  @override
  _SMSprintBacklogDetailsScreenState createState() =>
      _SMSprintBacklogDetailsScreenState();
}

class _SMSprintBacklogDetailsScreenState
    extends State<SMSprintBacklogDetailsScreen> {
  ...
  void _navigateToTaskDetails(Map<String, dynamic> task) {
    ...
    Navigator.push(
      ...
      // Reload the backlog item details to ensure we have the latest data
      _loadBacklogItemDetails();
    });
  }
